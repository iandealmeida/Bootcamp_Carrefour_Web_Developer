...
|Mostrar arquivos do diretório          |`"dir"`            |`"ls / ls -a"`            |
|Remover diretório          |`"del / rmdir"`            |`"rm -rf"`            |
|Remover diretório          |`"cls"`            |`"rm -rf workspace/"`            |
|Limpar tela do terminal    |`"cd .."`            |`"clear (crol + L"`            |
...
Conjunto de funções hash desenvido pela NSA
